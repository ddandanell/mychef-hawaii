...
export default function Layout() {
  ...
  return (
    ...
    >
      ...
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[60] focus:bg-ink focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-[#F6F1E8]"
      >
        Skip to content
      </a>
      <Navbar />
