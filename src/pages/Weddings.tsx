...
const islandsWeddings = [
  {
    ...
    alt: 'A wedding-week long table under a banyan at dusk, ocean lawn beyond. Campaign still, not a documented event.',
  },
  {
    id: 'oahu' as const,
    title: 'Oʻahu',
    body: 'Celebration dinners and weekend stacks in Ko Olina, Kahala and windward estates.',
    img: '/photos/oahu-villa-lanai-plated-dinner-dusk.jpg',
    alt: 'Plated villa dinner at dusk — seared fish, orchid, candlelight. Campaign still, not a documented event.',
  },
  {
    id: 'kauai' as const,
    title: 'Kauaʻi',
    ...
    alt: 'Chef’s hands finishing seared fish in a Kauaʻi villa kitchen, misted mountains beyond. Campaign still, not a documented event.',
  },
  {
