...
export const islands: Record<IslandId, IslandMeta> = {
  oahu: {
    ...
    basePath: '/oahu',
    selectorImage: '/photos/island-oahu.jpg',
  ...
  maui: {
    ...
    basePath: '/maui',
    selectorImage: '/photos/island-maui.jpg',
  ...
  kauai: {
    ...
    basePath: '/kauai',
    selectorImage: '/photos/island-kauai.jpg',
  ...
  bigisland: {
    ...
    basePath: '/bigisland',
    selectorImage: '/photos/island-bigisland.jpg',
