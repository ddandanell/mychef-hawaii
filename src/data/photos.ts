/**
 * Canonical photography map — seven campaign stills David approved.
 * Every leftover URL in /public copies one of these files so old pixels
 * cannot ship. Alts stay honest: concept images, not documented events.
 */
