...
export const locations: LocationRecord[] = [
  /* ---------------- Oʻahu ---------------- */
  {
    ...
    hero: '/photos/oahu-villa-lanai-plated-dinner-dusk.jpg',
    heroAlt: 'Plated villa dinner at dusk — seared fish, orchid, candlelight. Campaign still for the Waikīkī corridor, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/oahu-villa-lanai-plated-dinner-dusk.jpg',
    heroAlt: 'Intimate villa table at dusk — seared fish and candlelight. Campaign still for the Kahala corridor, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/oahu-vacation-chef-pool-breakfast.jpg',
    heroAlt: 'Vacation-chef breakfast by a villa pool — tropical fruit, omelette, croissants. Campaign still for Ko Olina, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/oahu-vacation-chef-pool-breakfast.jpg',
    heroAlt: 'Poolside morning table with tropical fruit and a folded omelette. Campaign still for Kailua, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/kohala-grilled-whole-fish-lava-golden-hour.jpg',
    heroAlt: 'Whole grilled fish on a rocky Hawaiian shore at sunset. Campaign still for the North Shore corridor, not a documented event.',
  ...
  /* ---------------- Maui ---------------- */
  {
    ...
    hero: '/photos/maui-villa-terrace-cocktail-bar.jpg',
    heroAlt: 'Sunset cocktail service on a villa terrace overlooking the Pacific. Campaign still for Wailea, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/maui-villa-terrace-cocktail-bar.jpg',
    heroAlt: 'West-Maui sunset bar setup with citrus, copper tools and coupe glasses. Campaign still for Kāʻanapali, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/maui-villa-terrace-cocktail-bar.jpg',
    heroAlt: 'Terrace cocktail hour at sunset — orchids, citrus, Pacific. Campaign still for Kapalua, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/kohala-grilled-whole-fish-lava-golden-hour.jpg',
    heroAlt: 'Grilled whole fish on lava rock at golden hour. Campaign still for Makena, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/kauai-chef-plating-seared-fish-mountains.jpg',
    heroAlt: 'Chef plating seared fish with misted mountain slopes beyond. Campaign still for Upcountry Maui, not a documented event.',
  ...
  /* ---------------- Kauaʻi (inquiry) ---------------- */
  {
    ...
    hero: '/photos/kauai-chef-plating-seared-fish-mountains.jpg',
    heroAlt: 'Chef’s hands finishing seared fish, misted mountains beyond. Campaign still for Kauaʻi North Shore, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/kauai-chef-plating-seared-fish-mountains.jpg',
    heroAlt: 'Open-kitchen plating against misted Hawaiian mountains. Campaign still for Kauaʻi South Shore, not a documented event.',
  ...
  /* ---------------- Hawaiʻi Island (inquiry) ---------------- */
  {
    ...
    hero: '/photos/kohala-grilled-whole-fish-lava-golden-hour.jpg',
    heroAlt: 'Whole grilled fish and tropical fruit on lava rock at golden hour. Campaign still for Kona, not a documented event.',
  ...
  },
  {
    ...
    hero: '/photos/kohala-grilled-whole-fish-lava-golden-hour.jpg',
    heroAlt: 'Whole grilled fish on Kohala lava rock, Pacific sunset beyond. Campaign still, not a documented event.',
